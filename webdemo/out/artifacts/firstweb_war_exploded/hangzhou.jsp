...
<head>
    ...
    <script src="http://webapi.amap.com/maps?v=1.4.3&key=2b0c35fea8683be407d581ac304f2e63"></script>
    ...
    <div class="sp-slides">
        ...
        <div class="sp-slide clean-main-slides">
            ...
            <h1 class="sp-layer clean-slider-text-big"
                ...
                <span class="clean-color-contras">游·乐</span> - 谁把杭州曲子讴，荷花十里桂三秋。
            </h1>
            <p class="sp-layer"
        ...
        <div class="row">
            ...
            <div class="clean-what-we-do">
                ...
                <div class="col-md-3 col-sm-3 col-xs-12 clean-blurb-round-icon wow bounceInLeft">
                    ...
                    <h3>谁把杭州曲子讴</h3>
                    <p>浙江省东北部的杭州，历史可以追溯到两千多年的秦朝。<br>
                        这座自古就被人称作“人间天堂”的杭城，山、泉、湖、桥、塔、寺样样俱全。<br>
                        西湖沿岸，城市和公园并没有绝对的界限，茂盛的植被与各色小店融为一体。<br>
                        这正是杭州有趣的地方，到处被大自然的绿意包围，却也没有远离城市的空旷感。</p>
                </div>
                ...
                <div class="col-md-3 col-sm-3 col-xs-12 clean-blurb-round-icon wow bounceIn" data-wow-delay=".5s">
                    ...
                    <h3>闲愁都几许</h3>
                    <p>3-4月、9-10月是杭州的最佳旅行时间。但品味杭州，无所谓季节，也无所谓天气。<br>
                        9-11月：天气秋高气爽，满陇桂雨的桂花飘香十里。<br>
                        3-5月：春风和煦，春水醉人。<br>
                        6-8月：盛夏季节，天气炎热。<br>
                        12-2月：严冬时节，腊梅竞放，孤山赏梅、灵峰探梅、超山访梅三大赏梅圣地不可不去，西湖十景之一的“断桥残雪”此时也迎来最动人时节。</p>
                </div>
                ...
                <div class="col-md-3 col-sm-3 col-xs-12 clean-blurb-round-icon wow bounceIn" data-wow-delay=".5s">
                    ...
                    <h3>富贵比贫贱</h3>
                    <p>杭州的消费水平与北京、上海等国内一线城市大致持平。<br>
                        餐饮：一般正餐的人均价格大概在50-80元之间，楼外楼、知味观等高档一些的餐厅人均普遍超过100元；<br>若选择面食、生煎等小吃，大概20-30元就能解决。<br>
                        住宿：西湖附近的商务型酒店大概在200-300元之间/晚，四星酒店在300-500元之间/晚。</p>
                </div>
                ...
                <div class="col-md-3 col-sm-3 col-xs-12 clean-blurb-round-icon wow bounceInRight" data-wow-delay=".5s">
                    ...
                    <h3>雨雾杭州</h3>
                    <p>杭州的春日（3-5月）、秋季（9-11月）气温适宜，白天单衣加外套足以应对。<br>
                        杭州的盛夏（6-8月）非常湿热，怎么凉快怎么穿，但一定要做好防蚊虫叮咬和防晒措施。<br>
                        杭州的冬天（12-2月）非常湿冷，其中以1月气温最低，务必多穿些衣物御寒。</p>
                </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <p class="col-md-6 col-sm-6 col-xs-12 clean-custom-sec-text wow bounceInRight">
                <h3>关于杭州</h3>
                <p>杭州，简称“杭”，浙江省省会，位于中国东南沿海、浙江省北部、钱塘江下游、京杭大运河南端，是浙江省的政治、经济、文化、教育、交通和金融中心，长江三角洲城市群中心城市之一、长三角宁杭生态经济带节点城市、中国重要的电子商务中心之一。截至2017年，杭州下辖10个区、2个县，代管1个县级市，总面积16596平方公里，常住人口为918.8万人，城镇化率76.2%。
                <br><br>2016年，杭州居民人均可支配收入46116元，社会消费品零售总额5176.20亿元。</p>
                <p>杭州自秦朝设县治以来已有2200多年的历史，曾是吴越国和南宋的都城。因风景秀丽，素有“人间天堂”的美誉。杭州得益于京杭运河和通商口岸的便利，以及自身发达的丝绸和粮食产业，历史上曾是重要的商业集散中心。后来依托沪杭铁路等铁路线路的通车以及上海在进出口贸易方面的带动，轻工业发展迅速。
                    <br><br>新世纪以来，随着阿里巴巴等高科技企业的带动，互联网经济成为杭州新的经济增长点。</p>
...
<section id="featured-works" class="clean-section-wrapper">
    ...
    <div class="container">
        <div class="row">
            ...
            <!-- Section Header -->
            <div class="col-md-12 col-sm-12 col-xs-12 clean-section-header wow fadeInDown">
                <h1><span class="clean-color-contras">杭州必体验</span></h1>
                <div class="clean-line"></div>
                <p class="col-md-8 col-sm-10 col-xs-12 col-md-offset-2 col-sm-offset-1"></p>
            </div>
            <!-- Section Header End -->
    ...
    <div class="copyrights">杭州必体验<a href="http://www.jq22.com/"  title="网站模板">网站模板</a></div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div>
                ...
                <style type="/text/css">
                    #MapContainer {width:600px; height: 360px; }
                </style>
                <script>
                    <!--地图-->
...
<section id="pricing" class="clean-pricing-section">
    <div class="container">
        <div class="row">
            ...
            <!-- Section Header -->
            <div class="col-md-12 col-sm-12 col-xs-12 clean-section-header wow fadeInDown">
                <h1><span class="clean-color-contras">美食与购物</span></h1>
                <div class="clean-line"></div>
