...
<div class="container" id=<%=SightName%>>
    <div class="header">
        <div align="center">
            ...
            <form class="sselect" id="form2" name="form2" method="post" action="/mainsights/mainpage.jsp">
                <%--<p>选择目的地：--%>
    ...
    <div class="content">
        ...
        <p name="detil" rows="18" readonly="readonly" id="detil"><h3>景点简介</h3><p><%=XiHu.getDescribe()%></p>
        </p>
